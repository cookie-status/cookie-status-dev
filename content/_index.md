...
| **Other** | <a href="/brave/" rel="footnote" class="fa fa-info-circle"></a> <span class="new">Removes known tracking parameters from URL query strings.</span> | n/a | <a href="/cliqz/" rel="footnote" class="fa fa-info-circle"></a> Algorithmically identify and purge unique user identifiers from requests to third-party domains. | n/a | n/a | n/a |
{{< /table >}}
