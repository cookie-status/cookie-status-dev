...
* Safari: `isLoggedIn` ([entry in the Privacy Community Group](https://github.com/privacycg/proposals/issues/16) and [latest explainer](https://github.com/WebKit/explainers/blob/main/IsLoggedIn/README.md)).
